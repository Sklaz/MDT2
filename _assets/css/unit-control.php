				...
				<div class="card-body">
					...
					<div class="row">
						<div class="form-group col-sm-12 col-md-6 col-lg-4">
        	   			...
        	   			<div class="form-group col-sm-12 col-md-6 col-lg-4">
        	        		<input type="submit" name='makeAch' class="btn state6 btn-green btn-block" value="Arrivé CH">
        	   			</div>
        	   			<div class="form-group col-sm-12 col-md-6 col-lg-4">
        	   			...
        	   			<div class="form-group col-sm-12 col-md-6 col-lg-4">
        	        		<input type="submit" name='makeCS' class="btn state9 btn-green btn-block" value="Arrivé CS">
        	   			</div>
						   </div>

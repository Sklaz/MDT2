...
<title>ANTARES - Refuser appel(s)</title>
		...
		<div class="row">
			...
			<div class="col-md-10">
				<div class="alert alert-danger state0" style="text-align: center;">
					<b>Bouton panique activé par <?php echo $unit['unit']; ?> (<?php echo $unit['collar']; ?>)</b><br><i>
				</div>
			</div>
		</div>
		<?php
		...
		<div class="col-md-10">
			<div class="card custom-card">
				<div class="card-body" style="padding: 5px !important;">
					<a href="#" data-toggle="modal" data-target="#endShift">Déconnecter tout le monde</a> | <a href="#" data-toggle="modal" data-target="#sendGlobalMessage">Envoyer message à tous</a>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="card-body" id="editCAD">
					...
					<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
						<div class="form-group col-md-12">
  						...
  						<div class="form-group col-md-12">
  							<input type="submit" name='dismissCall' class="btn btn-success btn-block" value="Ignorer l'appel">
  						</div>
  					</form>
				</div>
			</div>

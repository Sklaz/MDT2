...
<title>ANTARES - Déclencher</title>
			...
			<div class="card custom-card">
				...
				<table class="table table-responsive-xl" id="refreshDiv">
					<thead class="thead-light">
   						<tr>
   							<th scope="col">N°</th>
   							<th scope="col">Canal priorité</th>
	     					<th scope="col">Priorité</th>
   							<th scope="col">Description</th>
   							<th scope="col">Engin(s)</th>
	  				...
	  				<tbody>
    					...
    					<tr>
    						...
    						<?php if($call['status'] == 3){ ?>
    							<th class="text-success">Traité</td>
    						<?php }else{ ?>
    							<th class="text-danger">Non traité</td>
    						<?php } ?>
    					</tr>
    					<?php
    						}
				...
				<div class="card-body" id="editCAD" style="display: none;">
					...
					<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
						<div class="form-group col-md-12">
    						<label for="channel">Selectionner intervention</label>
    						<div id="cads">
  						...
  						<div class="form-group col-md-12">
    						<label for="channel">Véhicule(s)</label>
    						<div id="units">
  						...
  						<div class="form-group col-md-12">
  							<input type="submit" name='updateCall' class="btn btn-success btn-block" value="Déclencher">
  						</div>
  					</form>
				</div>
			</div>
				...
				<table class="table table-responsive-xl" id="availableUnits">
					<tbody>
						...
						<tr class="state<?php echo $unit['status']; ?>">
							<td><b><?php echo $unit['unit'] . " - " . $unit['collar'] . " - State " . $unit['status'] . " - Intervention " . $unit['callid']; ?></b></td>
						</tr>
						<?php
						}
						?>
  		...
  		<div class="modal-dialog" role="document">
    		<div class="modal-content" style="margin-top: 100px;">
      			<div class="modal-header">
        			<h5 class="modal-title" id="panicButton">Dispatch panique bouton</h5>
      			</div>
        				...
        				<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
							<div class="row">
								<div class="form-group" style="width: 100%;">
									<input type="submit" name='dispatchPanic<?php echo $unit['unitid']; ?>' class="btn btn-success btn-block" value="Dispatch tout véhicule(s)">
           						</div>
           					</div>
						</form>
						<?php

...
<head>
<title>ANTARES - Recherche victime</title>
<style type="text/css">
body {
...
<div class="container" style="margin-top: 25px;">
	<div class="row">
		...
		<div class="col-md-6">
			<div class="card">
				<div class="card-header">Rechercher victime</div>
				<div class="card-body">
					<?php
					...
					<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
						<div class="form-group col-md-12">
    						<label for="channel">Nom de la victime</label>
    						<input type="text" class="form-control" name="name" required>
                        </div>
                        <div class="form-group col-md-12">
                            <label for="channel">Date de naissance</label>
                            <input type="text" class="form-control" name="dob" placeholder="JJ/MM/AAAA" required>
                        </div>
  						<div class="form-group" style="width: 100%;">
							<input type="submit" name='searchPNC' class="btn btn-success btn-block" value="Rechercher">
						</div>
					</form>
				</div>
			</div>

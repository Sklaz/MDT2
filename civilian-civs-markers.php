...
<title>ANTARES - Antécédent(s) victime: <?php echo $civInfo['name']; ?></title>
        ...
        <div class="col-md-8">
            <div class="card custom-card">
                <div class="card-header">
                    Les antécédents de : <?php echo $civInfo['name']; ?>
                </div>
                <div class="card-body">
                    <?php
                    ...
                    ?>
                        <div class="alert alert-success"><b>Dossier modifié</b> le dossier a été mis à jour.</div>
                    <?php
